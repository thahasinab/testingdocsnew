...
class JiraCreateTool:
	...
	def __init__(self):
		...
		try:
			self.project_name, self.project_key = self.rs.connectors.get_jira_project(self.jira_username, self.jira_password_or_api_token, self.jira_url)
