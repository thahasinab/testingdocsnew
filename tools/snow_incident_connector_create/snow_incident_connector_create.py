...
class SnowIncidentConnectorTool:
	...
	def __init__(self):
		...
		try:
			self.tag_type_name, self.closed_status_value, self.closed_status_key, self.ticket_sync_string = self.rs.connectors.get_snow_fields(self.snow_username, self.snow_password_or_api_token, self.snow_url)
		...
		try:
			self.connector_id = self.rs.connectors.create_snow_connector(self.snow_connector_name, self.snow_username, self.snow_password_or_api_token, self.snow_url, self.tag_type_name, self.closed_status_value, self.closed_status_key, self.ticket_sync_string, client_id=None)				
