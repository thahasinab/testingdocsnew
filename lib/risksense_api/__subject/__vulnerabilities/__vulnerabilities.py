...
class Vulnerabilities(Subject):
    ...
    def search(self, search_filters:list, projection=Projection.BASIC, page_size=150,
        ...
        :return:    A list containing all vulnerability returned by the search using the filter provided.
        :rtype:     list
    ...
    def list_vulnerability_filter_fields(self,client_id:int=None):
    ...
    def get_model(self, client_id:int=None):
        ...
        :return:    Vulnerability projections and models are returned.
        :rtype:     dict
