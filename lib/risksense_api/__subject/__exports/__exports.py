...
class Exports(Subject):
    ...
    def check_status(self, export_id:int, client_id:str=None):
    ...
    def download_export(self, export_id:int, filename:str, client_id:int=None):
    ...
    def delete_files(self, export_id:int, client_id:int=None):
